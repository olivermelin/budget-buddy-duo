...
export function TransactionModal({ open, onOpenChange, defaultCategoryId }: Props) {
  ...
  }, [open, defaultCategoryId, state.categories, state.persons]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md rounded-2xl">
        <DialogHeader>
          <DialogTitle className="font-display text-xl">Ny transaktion</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              <Label>{type === "expense" ? "Betalare" : "Mottagare"}</Label>
        ...
        <DialogFooter className="gap-2 sm:gap-2">
          ...
          <Button onClick={submit} className="bg-gradient-primary rounded-xl">Spara</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
